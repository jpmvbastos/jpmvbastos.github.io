...
```{r setup, include=F}
area = "the challenges to accountability and democratic consolidation in Latin America"
tools = "design-based causal inference and computational social science to navigate research design trade-offs before data collection in experiments and quasi-experiments"
```
...
Given the focus on hard-to-observe phenomena, this substantive agenda also informs a methodological program on the application of tools from `r tools`. For the sake of brevity, I only focus on my substantive agenda.
