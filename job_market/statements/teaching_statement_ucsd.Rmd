...
```{r setup, include=F}
field = "public policy and researh methods"
comparative = "comparative politics and public policy"
cp_offer = "evidence-informed policy-making and the politics of the Global South"
methods_short = "research design and quantitative methods"
methods_offer = "research design, causal inference, data science, and computational social science"
source = "website"
```
