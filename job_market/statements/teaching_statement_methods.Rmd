...
```{r setup, include=F}
field = "political science and research methods"
...
methods_offer = "research design, causal inference, statistics for public policy, and computational social science"
source = "website"
```
