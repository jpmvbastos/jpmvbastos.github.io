...
cp_offer = "democracy and representation, the politics of the Global South, and evidence-informed policy making"
methods_short = "research design and quantitative methods"
methods_offer = "across the core quantitative methods sequences, research design, causal inference, data science, and computational social science"
source = "website"
```
...
I am prepared to teach courses on `r cp_offer`. I can also teach methodological courses `r methods_offer`. You can find copies of current and sample syllabi in my `r source`.