...
place = "the Université de Montréal. I am not a citizen or permanent resident of Canada. However, I have previously studied at the UdeM, which means that I can commit to teaching and mentoring in accordance to the language policy in a timely manner"
...
courses = "statistics, causal inference, experiments computational social science, machine learning, and their application to evidence-informed policy"
source = "website"
```
