...
tools = "design-based causal inference and computational social science to develop standards to navigate research design tradeoffs in experiments and quasi-experiments"
courses = "democracy and representation, comparative politics, politics of the Global South, evidence-informed policy, research design, statistics, experiments, causal inference, machine learning, and computational social science"
source = "website"
```
...
Substantively, I research `r area`. Methodologically, I use tools from `r tools`. My work is published or forthcoming in *World Development* and *The SAGE Handbook of Research Methods in Political Science and International Relations*, and the *Journal of Experimental Political Science*.
