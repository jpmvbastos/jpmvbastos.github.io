...
```{r setup, include=F}
place = "UT Austin"
jobtitle = "an Assistant Professor in Latin American Comparative Policy and Politics"
# specialty does not appear in methods letter
specialty = "comparative politics and quantitative methods" 
area = "evidence-informed policy to address the challenges to democracy in Latin America"
...
courses = "comparative politics, democracy and representation, Latin American politics, evidence-informed policy, research design, quantitative methods, and computational social science"
source = "website"
```
