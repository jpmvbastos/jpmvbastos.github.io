...
```{r setup, include=F}
place = "UNC"
jobtitle = "an Assistant Professor in American or Comparative Politics"
# specialty does not appear in methods letter
specialty = "comparative politics and quantitative methods" 
area = "political economy and political behavior in the Global South"
...
courses = "comparative politics, accountability and representation, the politics of the Global South, evidence-informed policy, research design, field experiments, and survey experiments"
