...
jobtitle = "an Assistant Professor in Comparative Politics with a focus on the developing world"
# specialty does not appear in methods letter
specialty = "comparative politics and quantitative methods" 
place = "Mississippi State"
area = "political economy and political behavior"
region = "the developing world"
tools = "design-based causal inference and computational social science"
courses = "comparative politics, the politics of development, evidence-informed policy, research design, computational social science, and quantitative methods"
```
