...
```{r setup, include=F}
place = "UW-Eau Claire"
jobtitle = "an Assistant Professor in Comparative Government"
...
courses = "comparative politics, accountability and representation, the politics of the Global South, evidence-informed policy, research design, computational social science, and quantitative methods"
source = "website"
```
...
Substantively, I teach and research on `r area`. Methodologically, I study the application of tools from `r tools`.
