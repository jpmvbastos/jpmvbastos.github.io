...
- Double list experiments [(Droitcour et al 1991)](https://doi.org/10.1002/9781118150382.ch11)
...
- [Double list experiments [(Droitcour et al 1991)](https://doi.org/10.1002/9781118150382.ch11)]{style="color: gray;"}
...
- Combining with other indirect questions needs altered designs or extra modeling assumptions (e.g. [Blair, Imai, and Lyall 2014](https://doi.org/10.1111/ajps.12086))
...
- **This project:** Replace direct questions with Network scale-up questions!
...
<!-- REMEMBER TO ONLY FOCUS ON ONE STRATEGY -->

- Facebook sample of Montevideo residents `(N = )`
