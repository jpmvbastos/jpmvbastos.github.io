...
- Have you had sex with someone who gave you money?

- Have you stolen from a previous employer?

- Do you know someone with links to a militant organization?

- Would you vote for a corrupt politician?
...
5. [**Sensitivity bias**]{style="color: #1d428a;"} 
...
- [Crosswise model]{style="color: gray;"} 

- [Network scale-up method]{style="color: gray;"} 

- [Endorsement experiments]{style="color: gray;"} 

- [Conjoint experiments]{style="color: gray;"} 
